...
export async function fetchAuthenticatedAsset(
  ...
  // Dostarczanie zasobow typu raw/authenticated bywa wylaczone w ustawieniach konta
  // Cloudinary i wtedy odrzuca nawet poprawnie podpisany adres. Pobranie uwierzytelnione
  // kluczem API takiemu ograniczeniu nie podlega. Adres powstaje i jest zuzywany WYLACZNIE
  // po stronie serwera, w tej funkcji, wiec klucz nigdy nie trafia do przegladarki --- to
  // wlasnie zastrzezenie przesadzilo wczesniej o rezygnacji z tej sciezki jako domyslnej.
